...
* **deps:** update dependency importlib_resources to v5 ([87904ee](https://github.com/opinionated-digital-center/pyadr/commit/87904ee2218147c318e083a60519cb81c00c6467))
...
* **git:** all changes staged when accept/reject ([cb3e753](https://github.com/opinionated-digital-center/pyadr/commit/cb3e753c5da9a62adbe5ff4a1ebcdee7a92cb51a))
...
* fix config incompatibilites between `pyadr` and `git adr` ([88dd2b8](https://github.com/opinionated-digital-center/pyadr/commit/88dd2b8262fbef5bed0b38404b3a98a764cd820d))

## [0.15.1](https://github.com/opinionated-digital-center/pyadr/compare/v0.15.0...v0.15.1) (2020-05-21)


### Bug Fixes

* fix exception on commit message when in adr only repo ([51963d5](https://github.com/opinionated-digital-center/pyadr/commit/51963d5f7e005dd580a61b897f9aad13c08d1440))
