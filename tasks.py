...
namespace_tox.add_task(tox_bdd, name="bdd")
namespace_tox.add_task(tox_bdd_all, name="bdd_all")
namespace_tox.add_task(tox_bdd_py311, name="bdd_py311")
namespace_tox.add_task(tox_bdd_py310, name="bdd_py310")
namespace_tox.add_task(tox_bdd_py39, name="bdd_py39")
namespace_tox.add_task(tox_bdd_py38, name="bdd_py38")
